...
d1_pr2_6=62.74;
d1_pr2_7=62.87;
d1_pr2_8=68.21; %(55.61 A Promedio)
...
% 5: Buffer Acetato de Sodio (medio)
n_med=1.3525;
k_med=0;
...
% *************************************************************************
% CÁLCULOS
theta_deg=65:.01:75; % Rango: 50° a 80°. Intervalos: 0.01°
...
plot(theta_deg,refle_1, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_1), ' A, \theta_{min} = ', num2str(thetacr_1), '°'])  
hold on;
plot(theta_deg,refle_2,'k', 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_2), ' A, \theta_{min} = ', num2str(thetacr_2), '°']) 
plot(theta_deg,refle_3, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_3), ' A, \theta_{min} = ', num2str(thetacr_3), '°'])
plot(theta_deg,refle_4, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_4), ' A, \theta_{min} = ', num2str(thetacr_4), '°'])
plot(theta_deg,refle_5, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_5), ' A, \theta_{min} = ', num2str(thetacr_5), '°'])
plot(theta_deg,refle_6, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_6), ' A, \theta_{min} = ', num2str(thetacr_6), '°'])
plot(theta_deg,refle_7, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_7), ' A, \theta_{min} = ', num2str(thetacr_7), '°'])
plot(theta_deg,refle_8, 'DisplayName',...
    ['d_{HSA} = ', num2str(d1_pr2_8), ' A, \theta_{min} = ', num2str(thetacr_8), '°'])
hold off;

title('SIMULACION CURVA SPR MUA+HSA+ACETATO DE SODIO')
ylabel('Reflectancia (%)')
xlabel('Angulo (°)')